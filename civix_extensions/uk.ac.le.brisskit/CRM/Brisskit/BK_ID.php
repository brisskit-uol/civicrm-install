...
class BK_ID {
  ...
  /* 
    Return the brisskit institutional prefix from the brisskit config file
    The prefix may be for a person or may be for a family
  */
  static function get_inst_prefix($family=FALSE) {
    #get brisskit config
  ...
  */
  ...
  /*
    Creates and returns a unique brisskit ID
    Now accepts an optional parameter to specift whether the ID is a family ID rather than for an individual
  */
  static function make_brisskit_id($family=FALSE)
  {
    ...
    $inst_prefix = self::get_inst_prefix($family);
    ...
    //Everything should have worked then :)
    return $proposed_bid;
  }
}
?>
